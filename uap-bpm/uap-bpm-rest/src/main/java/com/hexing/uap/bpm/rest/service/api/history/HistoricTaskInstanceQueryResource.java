...
package com.hexing.uap.bpm.rest.service.api.history;
...
public class HistoricTaskInstanceQueryResource extends HistoricTaskInstanceBaseResource {
    ...
    public ListDataResponse<HistoricTaskInstanceResponse> queryProcessInstances(@RequestBody HistoricTaskInstanceQueryRequest queryRequest, @ApiParam(hidden = true) @RequestParam Map<String, String> allRequestParams, HttpServletRequest request) {
        ListDataResponse<HistoricTaskInstanceResponse> response = new ListDataResponse<>();

        try {
            DataResponse<HistoricTaskInstanceResponse> result = getQueryResponse(queryRequest, allRequestParams,
