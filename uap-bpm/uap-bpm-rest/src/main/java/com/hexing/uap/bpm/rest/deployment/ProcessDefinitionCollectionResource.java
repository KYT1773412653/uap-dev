...
package com.hexing.uap.bpm.rest.deployment;
...
import com.hexing.uap.bpm.rest.service.api.repository.ProcessDefinitionResponse;
import com.hexing.uap.bpm.rest.service.api.repository.ProcessDefinitionsPaginateList;
...
import com.hexing.uap.bpm.rest.service.api.RestResponseFactory;
...
public class ProcessDefinitionCollectionResource {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "start", dataType = "int", value = "the begin value", paramType = "query"),
            @ApiImplicitParam(name = "tenantId", dataType = "string", value = "the tenant id", paramType = "query"),
            @ApiImplicitParam(name = "size", dataType = "int", value = "the number reqired", paramType = "query"),
    ...
    public ListDataResponse<ProcessDefinitionResponse> getProcessDefinitions(@ApiParam(hidden = true) @RequestParam Map<String, String> allRequestParams, HttpServletRequest request) {

        ListDataResponse<ProcessDefinitionResponse> response = new ListDataResponse<>();
        try {
            ...
            DataResponse<ProcessDefinitionResponse> result =  new ProcessDefinitionsPaginateList(restResponseFactory).paginateList(
                    allRequestParams, processDefinitionQuery, "name", properties);
